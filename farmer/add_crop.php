...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($crop_name) || empty($planting_date) || empty($base_price) || empty($stock_quantity)) {
        ...
        $estimated_harvest_end = date('Y-m-d', strtotime($estimated_harvest_start . ' + 15 days'));
    ...
    <div class="container mt-5">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control" name="discount_percentage" value="<?php echo htmlspecialchars($discount_percentage); ?>">
            </div>
            <div class="mb-3">
