        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="my_crops.php">My Crops</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="view_preorders.php">View Pre-Orders</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="view_requests.php">Community Requests</a>
                    </li>
                    <li class="nav-item">
